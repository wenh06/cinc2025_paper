...
def execute_cmd(cmd: Union[str, List[str]], raise_error: bool = True, cwd: Path = None) -> int:
    """
...
def main(args):
    ...
    if args.tex_entry_file:
        ...
        # If no file specified, default to main.tex and enable handout mode
        is_handout = True
    ...
    elif tex_entry_file.stem == MAIN_TEX_FILE.stem and is_handout:
        # Default main.tex and handout -> CinC2025...
        backup_pdf_name = f"CinC2025-Paper-{suffix}.pdf"
    else:
        # Other cases -> Original filename
