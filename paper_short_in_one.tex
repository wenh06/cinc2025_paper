...
Results: On the hidden validation set, our method received a Challenge score of 0.163 (rank 32~/~40). In cross-validation on the public training data, our approach achieved a Challenge score of 0.451.
